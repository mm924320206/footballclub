				...
				<form action="playerList.jsp">
					...
					<ul class="forminfo">
						<li><label>球员名称<b>*</b></label> <input name="name"
							type="text" class="dfinput" style="width: 518px;" value="" /></li>
						<li><label>球员年龄<b>*</b></label> <input name="age" type="text"
							class="dfinput" style="width: 518px;" value="" /></li>
						<li><label>球员薪资<b>*</b></label> <input name="salary"
							type="text" class="dfinput" style="width: 518px;" value="" /></li>
						<li><label>照片<b>*</b></label> <input name="file" type="file"
							style="width: 518px;" value="" /></li>
